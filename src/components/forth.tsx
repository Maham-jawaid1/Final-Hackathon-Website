...
export default function WhyChooseUs() {
  return (
    <section className="bg-black text-white py-10 px-6 sm:px-10 md:px-16 lg:px-24 flex flex-col lg:flex-row items-center justify-between">
      {/* Left Side: Images */}
      <div className="flex flex-col items-center lg:items-start space-y-6 lg:space-y-0 lg:space-x-6 lg:flex-row">
        <img
          src="../choose1.png"
        ...
        <img
          ...
          className="w-[50%] sm:w-[40%] lg:w-auto h-auto object-contain"
        />
      </div>
